    ...
    <footer className="relative text-white">
      <section className="relative min-h-[280px] overflow-hidden py-16 md:min-h-[320px] md:py-20">
        ...
        <SiteContainer className="relative z-[1] flex flex-col items-center gap-10 text-center">
          <div className="max-w-[806px] font-nav text-balance">
            <p className="text-[clamp(2rem,5vw,3rem)] font-bold leading-[1.1] text-neutral-50">Gradimo pouzdane temelje</p>
            <p className="text-[clamp(2rem,5vw,3rem)] font-bold leading-[1.1] text-primary">za vaše ambicije</p>
          </div>
        </SiteContainer>
      </section>
      ...
      <div className="border-t border-white/10 bg-background py-12 md:py-14">
        <SiteContainer>
          <div className="flex flex-col items-center gap-10 md:flex-row md:items-center md:justify-between">
            <Link href="/" className="shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
            ...
            >
              {navItemsAll.map((item) => (
                <Link
                  ...
                  className={cn(
                    "transition-colors",
                    isActive(pathname, item.href) ? "text-primary" : "text-neutral-500 hover:text-white",
                  )}
                >
                  {item.label}
                </Link>
      ...
      <div className="border-t border-white/10 bg-background py-6">
        <SiteContainer className="flex flex-col gap-4 px-6 font-sans text-base text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p className="leading-[26px]">© BAUEN DOO {year}. Sva prava zadržana.</p>
